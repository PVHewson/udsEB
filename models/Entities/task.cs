...
namespace uds.CRM.Model
{
	...
	public partial class Task : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public uds.CRM.Model.Account Account_Tasks
		{
			get
			{
				return this.GetRelatedEntity<uds.CRM.Model.Account>("Account_Tasks", null);
			}
			set
			{
				this.OnPropertyChanging("Account_Tasks");
				this.SetRelatedEntity<uds.CRM.Model.Account>("Account_Tasks", null, value);
		...
		public uds.CRM.Model.Contact Contact_Tasks
		{
			get
			{
				return this.GetRelatedEntity<uds.CRM.Model.Contact>("Contact_Tasks", null);
			}
			set
			{
				this.OnPropertyChanging("Contact_Tasks");
				this.SetRelatedEntity<uds.CRM.Model.Contact>("Contact_Tasks", null, value);
